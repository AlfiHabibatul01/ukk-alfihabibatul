    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Adukan Masalahmu Secara Online </h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Adukan masalah Anda di sini, kami akan Menindak lanjuti secepatnya.</h2>
          <div data-aos="fade-up" data-aos-delay="800">
            <a href="{{ url('login')}}" class="btn-get-started scrollto">Laporkan!</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="{{asset('img/hero-1.svg')}}" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
